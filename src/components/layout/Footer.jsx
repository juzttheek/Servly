        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul className="footer-links">
                <li><Link to="/services?category=home-cleaning">{t('footer.link_home_cleaning')}</Link></li>
                <li><Link to="/services?category=plumbing">{t('footer.link_plumbing')}</Link></li>
                <li><Link to="/services?category=electrical">{t('footer.link_electrical')}</Link></li>
                <li><Link to="/services?category=delivery">{t('footer.link_delivery')}</Link></li>
                <li><Link to="/services?category=photography">{t('footer.link_photography')}</Link></li>
              </ul>
            </div>
            ...
            <div className="footer-col">
              ...
              <ul className="footer-contact">
                <li>
                  <Mail size={16} />
                  <a href="mailto:hello@servly.lk">hello@servly.lk</a>
                </li>
                <li>
                  <Phone size={16} />
